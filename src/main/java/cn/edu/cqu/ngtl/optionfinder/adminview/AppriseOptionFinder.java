...
/**
 * Created by awake on 2016/12/13.
 */
public class AppriseOptionFinder extends KeyValuesBase {
    /**
    ...
    public List<KeyValue> getKeyValues() {
        ...
        String approveFunctionId = new TAMSWorkflowFunctionsDaoJpa().selectOneByName("评优").getId();
